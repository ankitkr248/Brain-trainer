...
public class MainActivity extends AppCompatActivity {
    ...
    public void refreshQuestion() {
        ...
        sumTextView.setText(String.valueOf(a) + function[val] + String.valueOf(b));
        ...
        else if(val==1)
        {
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    int randAnswer = rand.nextInt(20);
                    while (randAnswer == a - b) { // make sure that randAnswer != a + b
                        randAnswer = rand.nextInt(20);
                    }
                    answers.add(randAnswer);
                }
            }
        ...
        else if(val==2)
        {
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    int randAnswer = rand.nextInt(400);
                    while (randAnswer == a * b) { // make sure that randAnswer != a + b
                        randAnswer = rand.nextInt(400);
                    }
                    answers.add(randAnswer);
                }
            }
        ...
        else if(val==3)
        {
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    int randAnswer = rand.nextInt(40);
                    while (randAnswer == a % b) { // make sure that randAnswer != a + b
                        randAnswer = rand.nextInt(40);
                    }
                    answers.add(randAnswer);
                }
            }
